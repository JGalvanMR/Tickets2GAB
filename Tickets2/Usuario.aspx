        ...
        <div class="container col-xs-12 col-sm-12 col-md-12 col-lg-10">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    <center><h1>Solicitud de Soporte</h1></center>
                </div>
                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
				...
				<div class="tab-pane fade in active" id="nueva">
                        ...
                        <table class="table table-bordered table-responsive">
                            <thead>
					            ...
					            <tr>
						            <td><asp:Label runat="server" ID="lblUsuario"></asp:Label></td>
						            <td><asp:Label runat="server" ID="lbNombre"></asp:Label></td>
						            <td><asp:Label runat="server" ID="LbEmail"></asp:Label></td>
						            <td><asp:Label runat="server" ID="LbTele"></asp:Label></td>
					            </tr>
			            </table>
                        <hr/>
